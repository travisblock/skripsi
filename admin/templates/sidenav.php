		...
		<div class="scroll-sidebar" data-sidebarbg="skin6">
				...
				<nav class="sidebar-nav">
						<ul id="sidebarnav">
								...
								<li class="sidebar-item"> <a class="sidebar-link" href="?page=verifikasi_vendor"
												aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
														class="hide-menu">Verifikasi Vendor
												</span></a>
								</li>
								<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="?page=data_vendor"
												aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
														class="hide-menu">Data Vendor</span></a></li>
